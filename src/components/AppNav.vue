  ...
  <b-navbar ref="navFloating" toggleable="lg" type="dark" variant="brand-primary-gradient" :sticky="isSticky || !isFloating" :class="[(!isSticky && isFloating) ? 'nav-floating' : 'navbar-fixed-top']">
    <div class="container">
      ...
      <b-collapse id="nav-collapse" is-nav>
        <b-navbar-nav>
          <b-nav-item to="/MinesweeperJS">MinesweeperJS</b-nav-item>
          <b-nav-item to="/SpectrumToRGB">SpectrumToRGB</b-nav-item>
          <b-nav-item to="/DNAAlignmentXY">DNAAlignmentXY</b-nav-item>
        </b-navbar-nav>
      </b-collapse>
    </div>
  </b-navbar>
